...
import JerseyUploader from "@/components/jerseys/JerseyUploader";
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Add New Jersey</h1>
      </div>
      
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6">
          <JerseyUploader onSuccess={() => router.push("/admin/jerseys")} />
        </div>
      </div>
    </div>
  );
